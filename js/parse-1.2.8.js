...
( function(root) {
        ...
        Parse._request = function(route, className, objectId, method, dataObject) {
            ...
            if (route !== "batch" && route !== "classes" && route !== "files" && route !== "functions" && route !== "login" && route !== "push" && route !== "requestPasswordReset" && route !== "users") {
...
( function(root) {
        ...
        /** @lends Parse.Object.prototype */
        {
            ...
            destroy : function(options) {
                ...
                var request = Parse._request("classes", this.className, this.id, 'DELETE');
...
( function(root) {
        ...
        }, /** @lends Parse.User */
        {
            ...
            requestPasswordReset : function(email, options) {
                ...
                var request = Parse._request("requestPasswordReset", null, null, "POST", json);
...
( function(root) {
        ...
        Parse.Query.prototype = {
            ...
            find : function(options) {
                ...
                var request = Parse._request("classes", this.className, null, "GET", this.toJSON());
            ...
            count : function(options) {
                ...
                params.limit = 0;
                params.count = 1;
                var request = Parse._request("classes", this.className, null, "GET", params);
...
( function(root) {
        ...
        _.extend(Parse.Cloud, /** @lends Parse.Cloud */
        {
            ...
            run : function(name, data, options) {
                var request = Parse._request("functions", name, null, 'POST', Parse._encode(data, null, true));
